                ...
                <div class="col">
					...
					else 
					{
						if (isset($_POST["rejestruj"])) 
						{
							...
							if (!isset($_POST["username"]) || !isset($_POST["psw"]) || !isset($_POST["psw1"])) {
								echo '<h2>Nie wszystkie pola formularza zostały wypełnione!</h2>';
								echo '<div class="dottedline"></div>';
								drukuj_form();
							} else {
								$sql = "select * from moderatorzy where login = '" . $_POST["username"] . "'";
								...
								if ($result->num_rows > 0) {
									...
									if ($_POST["psw"] !== $_POST["psw1"]) {
										...
										$sql = "insert into moderatorzy values ("."NULL,'".$_POST["username"]."','".hash('sha256', $_POST["psw"])."')";
